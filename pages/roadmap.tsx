    ...
    <>
      ...
      <div className="container px-4 py-16 mx-auto">
        <div className="max-w-4xl mx-auto mb-16">
          <h1 className="text-5xl font-bold mb-6 text-gradient">OCF Roadmap</h1>
          <p className="text-xl text-gray-400 mb-8">A detailed timeline of our development process, milestones, and future plans</p>
