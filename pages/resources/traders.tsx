...
const scamTypes = [
  {
    id: 'rug-pull',
    name: 'Rug Pull',
    icon: <FaSkull className="text-primary" size={24} />,
...
export default function Traders() {
  ...
  return (
    <>
      <Head>
        <title>For Traders | Open Crypto Foundation</title>
        <meta name="description" content="Essential knowledge for crypto traders to identify scams, understand market manipulations, and trade safely in the DeFi ecosystem." />
      </Head>
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Essential knowledge for navigating the crypto landscape safely. Learn to identify scams, understand market manipulations, and make informed trading decisions.
            </p>
          </div>

          {/* Main content */}
          <div className="max-w-4xl mx-auto mb-16">
            <h2 className="text-2xl md:text-3xl font-bold mb-6 text-white">Common Scam Types in Crypto</h2>
            ...
            <TabLayout
              ...
              activeTab={activeScam}
              onTabChange={setActiveScam}
              tabPosition="side"
            >
              {scamTypes.map((scam) => (
                <div
                ...
                >
                  <h3 className="text-2xl font-bold text-white mb-4 flex items-center">
                    {scam.icon}
                    <span className="ml-2">{scam.name}</span>
                  </h3>
                  <p className="text-gray-300 mb-6 text-lg">{scam.description}</p>
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-dark-light/10 p-5 rounded-lg border border-dark-light/20">
                      ...
                      <ul className="list-disc pl-5 text-gray-300 space-y-2">
                        {scam.details && scam.details.map((detail, i) => (
                          <li key={i}>{detail}</li>
                        ))}
                      </ul>
                    </div>
                  ...
                  {/* If this is the platform-specific scams section and it has tactics breakdown */}
                  {scam.id === 'platform-scams' && scam.scamTactics && (
                    <div className="mt-8">
                      <h3 className="text-xl font-bold text-white mb-4">Scam Tactics Breakdown</h3>
                      <div className="space-y-6">
                        {scam.scamTactics.map((tactic, i) => (
                          <div key={i} className="bg-dark-light/10 border border-dark-light/20 rounded-lg p-5">
                  ...
                  {scam.id === 'kol-alerts' && scam.tacticsBreakdown && (
                    <div className="mt-8">
                      <h3 className="text-xl font-bold text-white mb-4">KOL Tactics Breakdown</h3>
                      <div className="space-y-6">
                  ...
                  {scam.id === 'kol-alerts' && scam.psychologySection && (
                    <div className="mt-8">
                      <h3 className="text-xl font-bold text-white mb-4">The Psychology Behind KOL Influence</h3>
                      <div className="space-y-6">
          ...
          <div className="max-w-4xl mx-auto bg-dark-card rounded-xl shadow-xl overflow-hidden mb-16 border border-dark-light/30">
            <div className="p-8 md:p-12">
              <h2 className="text-2xl font-bold mb-4 text-white">Stay Protected While Trading</h2>
              <p className="text-gray-300 mb-6">
                The best defense against scams is knowledge and vigilance. Use our tools to help you identify potential risks before investing:
              </p>
