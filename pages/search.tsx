...
const searchDatabase = [
  { title: 'OCF Token', path: '/ocf-token', content: 'Learn about the OCF token governance and benefits for holders', category: 'Token' },
  ...
  { title: 'Presale', path: '/presale', content: 'Participate in the OCF token presale event', category: 'Token' },
  { title: 'DAO Governance', path: '/ocf-token#governance', content: 'Learn about the DAO governance process and how to participate', category: 'Governance' },
