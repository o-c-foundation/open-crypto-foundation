          ...
          <div className="bg-dark-card border border-dark-light/30 rounded-lg p-6 mb-8">
            <div className="flex items-center mb-4">
              <div className="bg-primary/10 p-3 rounded-full mr-4">
                <FaCoins className="text-primary" size={20} />
              </div>
              <h3 className="text-xl font-bold text-white">Presale Coming Soon</h3>
            </div>
            <p className="text-light-muted mb-4">
              Our token presale is launching in just 48 hours! Early participants will receive a 50% discount on token prices 
              compared to the public sale. Visit our presale page to learn more about participation details and benefits.
            </p>
