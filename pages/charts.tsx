...
// HTML-only implementation of Charts page without TypeScript complexities
const Charts = () => {
...
// Plain React component for layout without TypeScript
...
// Remove client-side check at module level
