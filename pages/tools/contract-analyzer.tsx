...
export default function ContractAnalyzerRedirect() {
  const router = useRouter()

  useEffect(() => {
    // Redirect to tools directory after 5 seconds
    const redirect = setTimeout(() => {
      router.push('/tools#contract-checker-tools')
    }, 5000)
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Our contract analyzer tools have moved to our verified tools directory" />
      </Head>
      ...
      <section className="py-20 bg-gray-900">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <a 
              href="/tools#contract-checker-tools" 
